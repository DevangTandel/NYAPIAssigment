...
extension UIColor {
    ...
    //MARK: - Generate Random Color With Speicied Alpha Component
    convenience init( _ aplha : CGFloat) {
        ...
        self.init(red: r, green: g, blue: b, alpha: aplha)
    }
    
    //MARK: - Color With Speicied HEX string and Alpha Component
